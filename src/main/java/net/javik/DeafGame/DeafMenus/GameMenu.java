...
public class GameMenu extends ImageMenu implements IDeafMenu, MouseListener {
    ...
    public GameMenu(DeafWindow window, int height, int width, String backgroundImage, String version) {
        /*
